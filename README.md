...
1. Clone this repository:
   ```bash
   git clone [https://github.com/sorooshaghaei/projet-programmation-distribuee.git](https://github.com/sorooshaghaei/projet-programmation-distribuee.git)

2. Navigate to the project directory:

```Bash
cd projet-programmation-distribuee
