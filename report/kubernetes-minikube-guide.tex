...
\node[box, fill=mintwash, right=30mm of deployment] (service) {Service\\stable entry point};
\node[box, fill=skywash, below=14mm of service] (ingress) {Ingress / external\\HTTP rule};
